...
export class EmissionEvaluation extends BaseEntity {
  ...
  @Column({ type: 'varchar', length: 45, name: 'mon_plan_id', nullable: false })
  ...
  @ManyToOne(() => MonitorPlan, (plan) => plan.emissionEvaluations)
  @JoinColumn({ name: 'mon_plan_id' })
  monitorPlan: MonitorPlan;

  @ManyToOne(() => ReportingPeriod, (period) => period.emissionEvaluations)
